...
} from "../astro/assets-service_B2Xs4MrO.mjs";
import "clsx";
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      "../astro/assets-service_B2Xs4MrO.mjs"
    )
      .then((n) => n.s)
      .catch((e) => {
...
const $$Astro$1 = createAstro("https://darling-trifle-c84866.netlify.app");
const $$Image = createComponent(
  ...
  "C:/dev/tltr-astro/node_modules/astro/components/Image.astro",
  void 0,
);

const $$Astro = createAstro("https://darling-trifle-c84866.netlify.app");
const $$Picture = createComponent(
  ...
  "C:/dev/tltr-astro/node_modules/astro/components/Picture.astro",
  void 0,
);
